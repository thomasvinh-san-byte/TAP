    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <form action={onSubmit} className="mt-24 space-y-24">
          ...
          <FormSection title="Données touchées">
            <div className="space-y-8">
          ...
          <FormSection title="Description et mesures">
            <div className="space-y-8">
            ...
            <div className="space-y-8">
              ...
              <Textarea id="immediate_measures" name="immediate_measures" rows={3} required />
            </div>
          </FormSection>
