...
/**
 * Champs composés et indicateur d'auto-save du modal saisie express —
 * extraits de `ride-express-form-fields.client.tsx` (Phase 06.27 lot 4).
 *
 * Tous sont des composants de présentation purs ; la logique métier
 * (DEC-016) reste dans le modal parent.
 */
