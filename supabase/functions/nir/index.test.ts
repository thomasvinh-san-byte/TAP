...
Deno.env.set('APP_NIR_ENCRYPTION_KEY', 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=');
Deno.env.set('APP_NIR_SEARCH_KEY', 'QkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkI=');
...
// 6. handler decrypt insère audit_logs action='patient.nir.decrypt'
// ---------------------------------------------------------------------------
Deno.test("handler decrypt insère une ligne audit_logs action='patient.nir.decrypt'", async () => {
