...
select ok(
  has_table_privilege('authenticated', 'public.internal_general_message', 'SELECT')
    ...
    and not has_table_privilege('authenticated', 'public.internal_general_message', 'UPDATE')
    and not has_table_privilege('authenticated', 'public.internal_general_message', 'DELETE'),
