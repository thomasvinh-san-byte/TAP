...
- [ ] **SAIS-07** : Smart defaults mode + urgence depuis dernière course patient (Phase 03.1) — pré-remplissage silencieux quand le formulaire est encore aux défauts V1.
