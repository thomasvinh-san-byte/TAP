...
- [ ] **Phase 06.13: Foundations design system** — Phase documentaire pure (0 ligne code applicatif). 4 livrables : `docs/design-system/01-foundations.md` (doctrine et conventions visuelles WCAG 2.1 AA + RGAA 4.1.2), `apps/web/src/styles/tokens.json` (design tokens W3C-standard 2025.10), `docs/design-system/02-patterns-emergents.md` (catalogue 5 patterns réutilisables : KpiCard, EmptyState, RideBadge, SlaBadgesCard, HautsBadge), `docs/design-system/03-benchmark-foss.md` (capitalisation recherche FOSS méthodique 2026-06-03 : Carbon + Atlassian + NHS étoile polaire hybride). Estimation 7-11 h sur 1 PR. **DEC-088..091 LOCKED.** Pas de migration BDD, pas de dépendance. Cadre pour Phases 06.14 (migration tokens → Tailwind config), 06.15 (refonte data tables Carbon-inspired), 06.16 (refonte settings Linear+Stripe inspired).
